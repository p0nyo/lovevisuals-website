...
export default function Contact() {
    ...
    return (
            <div className="bg-[#678BAA] relative min-h-screen w-full py-20 px-40 flex flex-col gap-10">
                        ...
                        {fields.map(({ label, type, placeholder }) => (
                            <div key={label}>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2 bg-white text-black placeholder:text-gray-400 placeholder:italic rounded-sm focus:outline-none"
                                />
                                ) : (
                                <input
                                    type={type}
                                    placeholder={placeholder}
                                    className="w-full px-4 py-2 rounded-sm bg-white text-black placeholder:text-gray-400 placeholder:italic focus:outline-none"
                                />
                                )}
                            </div>
                        ))}
